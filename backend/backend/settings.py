...
SECRET_KEY = 'django-insecure-+qw34e3&kz(lc23&71w7j6j7gq9e3ru3@rg%p90oeulaxba@i^'
...
INSTALLED_APPS = [
    'jazzmin',  # Jazzmin for enhanced admin interface
    ...
    # custom apps
    'api',  # Example app, replace with your actual app names

    # third-party apps,
    'rest_framework',  # Django REST Framework for building APIs
    'corsheaders',  # CORS headers for handling cross-origin requests
    'drf_yasg',  # For API documentation with Swagger
    'rest_framework_simplejwt.token_blacklist',  # Token authentication for DRF
]
...
JAZZMIN_SETTINGS = {
    "site_title": "WDays Admin",
    "site_header": "WDays Admin",
    "site_brand": "Modern Blog ",
    # "site_icon": "images/favicon.ico",
    # "site_logo": "images/logos/logo.jpg",
    "welcome_sign": "Welcome To WDays Admin",
    "copyright": "WDays © 2025",
